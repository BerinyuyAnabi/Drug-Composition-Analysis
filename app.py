...
def clean_and_split_list(input_list):
    ...
    try:
        ...
        st.error(f"Error in cleaning and splitting list: {e}")
        return []
...
def process_item(item):
    try:
        ...
        st.error(f"Error in processing item: {e}")
        return item
    ...
    try:
        ...
        if full_text:
            ...
            if medicine_data.empty:
                st.error("Medicine data is not available. Please check the data source.")
            else:
                ...
                if user_input:
                    if user_input in medicine_names:
                        ...
                        try:
                            ...
                            st.warning("No URL found for the input drug name")
                    else:
